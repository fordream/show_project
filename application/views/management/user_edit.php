...
<!--    </div>-->
    ...
    <div class="form-group fix">
        ...
        <div class="input-group date form_datetime col-md-4" data-date="2015-04-01T05:25:07Z" data-date-format="yyyy-mm-dd hh:ii:ss" data-link-field="dtp_input1">
            <input class="form-control" name="limitime" id="limitime" size="16" type="text" value="2030-01-01 00:00:00" readonly>
    ...
    <div class="form-group fix">
        <label for="auth-project" class="col-sm-2 control-label">授权项目：</label>
        <div class="">
            <input type="checkbox" name="proj-detial" value="2">新建查询(预览)
            <input type="checkbox" name="proj-detial" value="3">报表管理(预览)

            <input type="checkbox" name="proj-detial" value="5">报表定制(预览)
            <input type="checkbox" name="proj-detial" value="7">报表定制(Haw) <br>

            <input type="checkbox" name="proj-detial" value="11">乱价管理(可用)
            <input type="checkbox" name="proj-detial" value="13">任务管理(预览)

            <input type="checkbox" name="proj-detial" value="17">知识管理(预览)
            <input type="checkbox" name="proj-detial" value="19">规则模块(预览)
        </div>
    </div>
