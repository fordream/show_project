...
class MManagement extends MY_model
{
    ...
    public function update_user_changepassword($db, $username, $password, $is_valid, $uid){
        //更新用户信息
        ...
        $res_update_user = $this->my_query($db, $sql_update_user, array($username, $password, $is_valid, $uid));
    ...
    public function update_user_holdpassword($db, $username, $is_valid, $uid){
        //更新用户信息
        $sql_update_user = "UPDATE `etc_user`
                        SET `username` = ?,
                        `is_valid` = ?
        ...
        $res_update_user = $this->my_query($db, $sql_update_user, array($username, $is_valid, $uid));
    ...
    public function set_groupid($group_value,$group_text, $username) {

        $sql = "update `etc_user` set `groupid` = ?,`group_text` = ? where `username` = ?";
        if(!($query =  $this->my_query('etc_privileges', $sql, array($group_value,$group_text,$username))))
        {
            $this->db->_error_message();
            return false;
        }
